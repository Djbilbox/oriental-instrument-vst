...
class AndroidMainComponent : public juce::Component
{
public:
    AndroidMainComponent();
    ~AndroidMainComponent() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(AndroidMainComponent)
};
